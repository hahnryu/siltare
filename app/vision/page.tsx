...
const ROADMAP = [
  ...
  { label: 'Layer 1 (4월)', body: '다중 세션 + 공유 + 알림' },
...
const GLOBAL_ITEMS = [
  ...
  { title: '공감의 플랫폼', body: '개인의 이야기가 쌓이면 집단의 기억이 됩니다. 남의 이야기를 읽는 것 자체가 경험. "부산 영도 피난"을 검색하면 서로 다른 가족의 시선이 교차합니다. 큐레이션된 이야기는 뉴스레터, 팟캐스트, 숏폼으로 확장됩니다.' },
];
